...
Source0  : https://ftp.osuosl.org/pub/cran/src/contrib/patrick_0.3.0.tar.gz
...
popd
pushd ..
cp -a patrick buildavx512
popd
pushd ..
cp -a patrick buildapx
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1738079882
